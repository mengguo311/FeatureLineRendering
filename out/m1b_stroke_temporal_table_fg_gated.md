...
|---|---|---|---|---|---|---|---|---|---|---|---|
| cadpartA | 240 | OURS | 0.030 | 0.069 | 0.022 | **0.131** | 0.131 | 0.000 | 0.000 | 28 | 4.68 |
| cadpartA | 240 | BASE | 1.457 | 2.592 | 0.504 | **0.646** | 0.645 | 0.001 | 0.000 | 76 | 2.30 |

## Headline ratios (BASELINE / OURS — higher means our strokes are steadier)

| scene | frames | Frechet med ratio | P_pop ratio |
|---|---|---|---|
| cadpartA | 240 | 48.31x | 4.93x |

## Stroke graphs

| scene | linelets | after 3D NMS | strokes | median vertices/stroke |
|---|---|---|---|---|
| cadpartA | 3049 | 294 | 41 | 5 |
