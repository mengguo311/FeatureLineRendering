...
for status in sorted(statuses):
 ...
 if task=='visibility':
  ...
  bootstrap += [O/'setup/visibility_worker.py',R/'out/multiscene_foundation_corrected/MANIFEST.json',ev/'frozen.json',*[ev/p for p in read_json(ev/'frozen.json')['artifacts']],base/'F',ev]
