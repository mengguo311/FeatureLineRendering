...
Held-out: TEST views only; trajectory 5->15.  Stroke variant: `dex040`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| lego | 240 | OURS | 0.078 | 0.473 | 0.048 | **0.063** | 0.034 | 0.029 | 0.001 | 1647 | 4.86 |
| lego | 240 | BASE | 1.204 | 2.557 | 0.421 | **0.719** | 0.717 | 0.002 | 0.161 | 615 | 2.24 |

## Headline ratios (BASELINE / OURS — higher means our strokes are steadier)

| scene | frames | Frechet med ratio | P_pop ratio |
|---|---|---|---|
| lego | 240 | 15.46x | 11.36x |

## Stroke graphs

| scene | linelets | after 3D NMS | strokes | median vertices/stroke |
|---|---|---|---|---|
| lego | 34176 | 19898 | 2711 | 4 |
