...
|---|---|---|---|---|---|---|---|---|---|---|---|
| cadpartA | 240 | OURS | 0.035 | 0.097 | 0.029 | **0.192** | 0.192 | 0.000 | 0.000 | 23 | 11.21 |
| cadpartA | 240 | BASE | 1.452 | 2.589 | 0.503 | **0.646** | 0.644 | 0.001 | 0.000 | 76 | 2.30 |

## Headline ratios (BASELINE / OURS — higher means our strokes are steadier)

| scene | frames | Frechet med ratio | P_pop ratio |
|---|---|---|---|
| cadpartA | 240 | 41.67x | 3.36x |
