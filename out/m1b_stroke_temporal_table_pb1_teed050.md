...
Held-out: TEST views only; trajectory 5->15.  Stroke variant: `teed050`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| lego | 240 | OURS | 0.081 | 0.491 | 0.049 | **0.069** | 0.037 | 0.033 | 0.001 | 1944 | 4.82 |
