...
\begin{figure*}[t]\centering\setcounter{figure}{0}\includegraphics[width=0.36\textwidth]{assets/fig1_teaser.png}\caption{Teaser: object-space strokes versus per-frame line detection, with a two-frame overlap visualizing stroke identity across a camera step.}\label{fig:1}\end{figure*}
