...
\begin{figure*}[t]\centering\setcounter{figure}{1}\begin{minipage}{0.475\textwidth}\centering\includegraphics[width=\textwidth]{assets/pareto_chair.png}\\(a) chair\end{minipage}\hfill\begin{minipage}{0.475\textwidth}\centering\includegraphics[width=\textwidth]{assets/pareto_lego.png}\\(b) lego\end{minipage}\caption{PARETO-1 precision/line-density operating frontiers: (a) chair, (b) lego.}\label{fig:2}\end{figure*}
